    ...
    <body>
        <div class="grid-container">
            ...
            <div class="form-container">
                ...
                <hr>
                <form method="POST" action="../easebuzz.php?api_name=initiate_payment">
                    <div class="main-form">
                        ...
                        <div class="mandatory-data">
                            ...
                            <div class="form-field">
                                ...
                                <input id="surl" class="surl" name="surl" value="http://bynaric.in/msbte_appr_proc/easebuzz/response.php" placeholder="http://bynaric.in/msbte_appr_proc/easebuzz/response.php">
                            </div>
                            
                            <div class="form-field">
                                <label for="furl">Failure URL<sup>*</sup></label>
                                <input id="furl" class="furl" name="furl" value="http://bynaric.in/msbte_appr_proc/easebuzz/response.php"
                                placeholder="http://bynaric.in/msbte_appr_proc/easebuzz/response.php">
                            </div>
