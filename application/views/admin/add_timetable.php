		...
		<table class="table  table-hover table-striped" id="ps_table" width="100%">
			...
			?>
			  <tr>
				  ...
				  <td>
					<!--<a href="base_url('update_timetable');<?php echo $val['id'] ?>" class="btn btn-primary">Edit</a>-->
						<a href="" class="btn btn-primary">Edit</a>
				  </td>
				  <td>
							<a href="javascript:void(0);" id="<?php echo $val['id']; ?>" class="btn btn-danger del">Delete</a>
				  </td>
			   </tr> 
			<?php } ?>
			</tbody>
...
$(".del").click(function(){
		var id = this.id;
   		$.ajax({
   			type: "POST",
   			url: "<?php echo base_url('admin/delete_timetable'); ?>",
   			data: {id : id},
